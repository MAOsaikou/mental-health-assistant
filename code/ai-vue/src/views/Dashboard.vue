...
// 统计图片引入
const iconUrl1 = new URL('@/assets/images/users.svg', import.meta.url).href
const iconUrl2 = new URL('@/assets/images/like.svg', import.meta.url).href
const iconUrl3 = new URL('@/assets/images/comments.svg', import.meta.url).href
const iconUrl4 = new URL('@/assets/images/smile.svg', import.meta.url).href
